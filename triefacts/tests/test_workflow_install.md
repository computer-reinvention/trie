...
file_fingerprint: 98cdafbdd0c5952e16b1e95d92e4ce5c9225df482fb611b854c5834f9b2a5d51
last_synced_at: '2026-07-25T06:05:59Z'
defines:
- kind: module
...
- kind: function
  ...
  lines: 30-44
- kind: function
  qualified_name: tests/test_workflow_install:test_render_sync_bot_budget_and_guards
  lines: 47-57
- kind: function
  qualified_name: tests/test_workflow_install:test_install_sync_bot_same_ownership_contract
  lines: 60-75
- kind: function
...
<!-- trie:end -->
<!-- trie:section symbol=tests/test_workflow_install:test_render_sync_bot_budget_and_guards fingerprint=2bd9be406013fe0f455387dd891abc6f904ef3ddb4ccb86fc15269ceac6f6db6 body_fp=630a9622511229c671ceb65796ab7c9dd3fce66e0a1553b8b858210ddb84809e source_ref=627f061096890d85cce4ef5f799c85e105f99a79 role=test -->
Verify that `render_sync_bot_workflow` bakes in the budget, API key secret, fork-safety guard, and `trie -q verify` gate.
<!-- trie:end -->
<!-- trie:section symbol=tests/test_workflow_install:test_install_sync_bot_same_ownership_contract fingerprint=c33b1192184a691f626107e502d50cf3f8bc35aff46093631a482c59827d5347 body_fp=299ac6c5364099fd6a5a3d9996cec657cde334d2dcf26b6afb479d83207a2a80 source_ref=627f061096890d85cce4ef5f799c85e105f99a79 role=test -->
Verify `install_sync_bot_workflow` follows the same create/unchanged/updated/skipped ownership contract as the triediff installer.
<!-- trie:end -->
