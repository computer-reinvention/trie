...
last_synced_at: '2026-05-12T18:23:37Z'
defines:
- kind: class
...
outgoing_refs: 29
---
<!-- trie:section symbol=tests/test_check:FakeClient fingerprint=e41cdf8484085fe52836a78fa046003a64b4ee976928802814aeb5dfbe564b63 body_fp=04724c75b20568efe20f2c6d96330b625682e73db28337e280f611c7a26176d9 -->
## `FakeClient`

Stub LLM client for tests; records call count and returns fixed generated text.

- `calls`: incremented on each `generate` invocation.
- `count_tokens`: always returns 100.
<!-- trie:end -->

<!-- trie:section symbol=tests/test_check:FakeClient.generate fingerprint=7328b86a4ba976097f1e8eec40c045a8090951dfeca29ef5debd39c4e6fc9a4b body_fp=4a2ff74fc7e50ad77c3087d0d612e94d2c091b11a523a93c9085afd03a6484ef -->
## `generate(self, _req: GenerationRequest) -> GenerationResponse`

Increment call counter and return a fixed `GenerationResponse` with stub token counts.
<!-- trie:end -->
...
<!-- trie:section symbol=tests/test_check:test_missing_triefact_detected fingerprint=198beaed352ba1847c55b9b432a978f034dd94e3c19901ab32419c89cde856e4 body_fp=26c59c800af1f4410d7b9da47d4461df219c83c452330fad45ab1eac796e87a6 -->
## `test_missing_triefact_detected(project: Path)`

Assert that `check_project` flags `StaleReason.MISSING_TRIEFACT` when no triefacts have been generated.
<!-- trie:end -->
...
<!-- trie:section symbol=tests/test_check:test_missing_section_detected fingerprint=474be3f403d0bc036a4e3b21eaa0aa313c358d28ce4173c0b1d0ede526d616de body_fp=db19ce9a117c1a5b0926da9cc5c89f51a777f3c3691066cfc4897044d76f6043 -->
## `test_missing_section_detected(project: Path)`

Assert that adding a new public symbol to a source file causes `check_project` to report `StaleReason.MISSING_SECTION` for that symbol.
<!-- trie:end -->

<!-- trie:section symbol=tests/test_check:test_orphan_section_detected fingerprint=fa609789a15518cf4c7d41859858f0a90c64b76d6872c4b0a50099bbf1e2c602 body_fp=1e714fd5a40ac6f056c1a205e7aa580719f4dc56317109c2594fd34123ff8891 -->
## `test_orphan_section_detected(project: Path)`

Assert that removing a symbol from source causes its triefact section to be flagged as `StaleReason.ORPHAN_SECTION`.
<!-- trie:end -->

<!-- trie:section symbol=tests/test_check:test_no_public_symbols_no_triefact_required fingerprint=b1880f912a31cce387f522f5a8bc16d42e42953fe89c985d9ca118e4cb5e7004 body_fp=bbf3d03d6f1a54378a7ee563e5e8bbfdcbc0121843e6a3c263128841eb9c348e -->
## `test_no_public_symbols_no_triefact_required(project: Path)`

Assert that files containing only private symbols produce no `check_project` items.
<!-- trie:end -->

<!-- trie:section symbol=tests/test_check:test_clean_when_all_in_sync_with_human_prose fingerprint=5dc7b3e44dcb10bc2ccf33dc2fadca8bd2532b0be41200707c9eede67ea30fe1 body_fp=ee104198158354c794849e58fc6ff0560da063f98bee3d35b42040305f425fb9 -->
...
<!-- trie:section symbol=tests/test_check:test_cli_verify_exits_nonzero_when_stale fingerprint=a2d2723a23ccfd370ddd351e2f787b5fc95d089db000fec0db9ecb9578e39a7f body_fp=472a4646a6f88a4edf5284a57dc77dda817088ab8743d9f13716df89507685fd -->
## `test_cli_verify_exits_nonzero_when_stale(project: Path, monkeypatch: pytest.MonkeyPatch)`

Assert `trie verify` exits 1 and names the stale symbol when a source file is modified after sync.
<!-- trie:end -->
...
<!-- trie:section symbol=tests/test_check:test_cli_verify_detects_tampered_body fingerprint=3f257a5401e691709ee97cb37ba08ba1fd44fae2fff9582e442a9f18a19f9985 body_fp=989f9d6ae450ee4138df3055c8fbba3f2479cb4a385e69fc437f07dfcf6da349 -->
## `test_cli_verify_detects_tampered_body(project: Path, monkeypatch: pytest.MonkeyPatch)`

Assert that the CLI `verify` command exits 1 and reports `TAMPERED_BODY` when section content is hand-edited.
<!-- trie:end -->

<!-- trie:section symbol=tests/test_check:test_check_project_detects_tampered_body fingerprint=3b649f08b4086f9eedbf600a0d41fe047f1c06935c73fabb5fd8026b11c56d62 body_fp=d5b015cd391e074aeb96679e0a02dbce1d66854fd70c067fea5d33592758c6e7 -->
## `test_check_project_detects_tampered_body(project: Path)`

Verify that `check_project` raises `TAMPERED_BODY` when section content is hand-edited after sync.
<!-- trie:end -->

<!-- trie:section symbol=tests/test_check:test_check_project_detects_legacy_section fingerprint=d27ffa0d7a2aadf38f56555fa46b32219e8c85c046bdb7dd2e6303fd58d483e7 body_fp=60a0e0b5b0cdea6390e6915ef391ed7c11bbb7487c5400a7379b848bcf793a40 -->
## `test_check_project_detects_legacy_section(project: Path)`

Assert that a triefact section missing the `body_fp=` attribute is flagged as `StaleReason.LEGACY_SECTION`.
<!-- trie:end -->