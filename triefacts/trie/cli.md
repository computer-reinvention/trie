...
trie_version: 0.1.9
source: trie/cli.py
file_fingerprint: 57b23813fcbeaf94fa6f56356ce70d755cba5002a688fec3b0bc0904f2058d7d
last_synced_at: '2026-07-20T23:25:31Z'
defines:
- kind: module
...
<!-- trie:end -->
<!-- trie:section symbol=trie/cli:_run_full_pass fingerprint=7d95a1915492c124bf4e1cd57c890fddd3506f3c704b834bb11aa7bd1d0282e7 body_fp=a3f63996eabb54f19bfaa9b0a9c5d12125b87ab13bc285598a28131753953fc1 source_ref=531556cb2ca369f928920ff2e8a5af396c7dd9ee role=orchestration -->
...
<!-- trie:end -->
<!-- trie:section symbol=trie/cli:_run_incremental_sync fingerprint=f9d0480c1c4ff3cdc1921900aed8e4f09e3e91d710286d21a362fb8284352bdc body_fp=2b16655553becaf9d2a82406503ac8a80c0305f39f70be0b7a9549f9c8e4c790 source_ref=531556cb2ca369f928920ff2e8a5af396c7dd9ee role=domain -->
...
<!-- trie:end -->
<!-- trie:section symbol=trie/cli:diff_cmd fingerprint=da0a350af258c6a5a0763db50f3f578f1fd74811a8fa7a8858e83b0741a5c737 body_fp=fa1a4111219592688ea3763c2a3d764faa6a4e3a6d8346ca6beeaa7bd4f70297 role=cli-interface -->
Typer command that collects session evidence (git triefact diff and patch notes) and either synthesises an LLM narrative for terminal display or, when `--write` is given, prepends a timestamped digest entry to the configured `TRIE_DIFF` file for use by the pre-commit hook. In write mode the command scopes evidence to changes since the base commit, optionally generates an LLM narrative (degrading silently to deterministic evidence on any failure so a commit is never blocked), updates the digest file via `upsert_digest`, and reports the digest path relative to the project root (falling back to the absolute path if a relative path cannot be computed); in terminal mode it honours `--raw` for plain evidence output, `--json` for machine-readable evidence, and the default path for full LLM narrative rendering. `--raw`/`--json` and `--write`/`--json` are mutually exclusive pairs that cause an early exit with code 1.
<!-- trie:end -->
...
<!-- trie:end -->
<!-- trie:section symbol=trie/cli:patch_apply_cmd fingerprint=fa8a2665139aeeaca22782601bda1177fdf3b59f7f5e7a3737f1d28fbcdf7ca9 body_fp=79c5b5d0bdb0ba2833f1edabddd8295392d7567c70ff0e89781e4e148cc5468d source_ref=531556cb2ca369f928920ff2e8a5af396c7dd9ee role=api -->
Execute all pending patches via the cascade-editing pipeline, dispatching to the `agent` (workorder), `llm`, or other configured backend.

- `--note`: required for multi-symbol applies; names the unifying intent.
- `--backend`: overrides config; `agent` emits a workorder envelope instead of generating code.
...
<!-- trie:end -->
<!-- trie:section symbol=trie/cli:plan_cmd fingerprint=373611a9d3e4483138772bfb37fc6df782949064514db26f320d72889ab86b34 body_fp=096967cbfb059eb00835ca8b327e555e0b3ad960d1a1450c36a0341c921cbd9b source_ref=531556cb2ca369f928920ff2e8a5af396c7dd9ee role=api -->
...
<!-- trie:end -->
<!-- trie:section symbol=trie/cli:setup_cmd fingerprint=0051558e5dd44636f47dea98a8f82c433c1de0f0d9efa31fbd1dd98e4cd9d1e1 body_fp=2c404ef25f92f2844eb0bf457b69f65575ebc192368579bb130b4198137c29af source_ref=531556cb2ca369f928920ff2e8a5af396c7dd9ee role=api -->
