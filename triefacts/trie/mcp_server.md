...
last_synced_at: '2026-07-25T06:06:19Z'
...
<!-- trie:end -->
<!-- trie:section symbol=trie/mcp_server:TrieTools.batch_patch fingerprint=aabe2c2d1a6cb256c1946e0873f6301ba56035937f81d700b0fb8f3a5e36c84b body_fp=799a7e5d2d0e226d1b005b4e85313fc4368cacd997f9713d567f708470990110 source_ref=c8b279d53ea4a7a3c856c698ff3b034c835ca920 role=api -->
...
<!-- trie:end -->
<!-- trie:section symbol=trie/mcp_server:TrieTools.create_symbol fingerprint=b755dec522310fa84d6809524fd7c4a617a02a83e5a076ab4ed3a2947a1fb6af body_fp=04db2cf65c048191eb7975184a9cfe39037b6e330a70765c223965ff3f3bc7b3 source_ref=c8b279d53ea4a7a3c856c698ff3b034c835ca920 role=api -->
...
<!-- trie:end -->
<!-- trie:section symbol=trie/mcp_server:TrieTools.commit fingerprint=c49b6f1c9ec16e23862c8fa0409b03b3babe9f950d2e209a9261f1e7c294d6f9 body_fp=ce4260eb05a167ce3b29fbd7a8950bb6c304ebf4c0159ece8edd3ffe5b9cfeb1 role=mcp-server -->
Stages and applies all pending patches and creates, returning either an executable agent worklist or a serialized ApplyReport depending on the effective backend. When the resolved backend (the explicit `backend` argument if non-empty, otherwise `self.config.edits.backend`) is `'agent'`, the method returns the result of `build_workorder` immediately—without acquiring the exclusive apply lock or performing any text generation—so that the caller's agent can execute the changes directly. For all other backend values the method acquires the exclusive apply lock to prevent concurrent applies, builds the appropriate edit backend and LLM client, runs `stage_and_commit` off the event-loop thread via a `ThreadPoolExecutor`, and returns the serialized `ApplyReport`.
<!-- trie:end -->
...
<!-- trie:end -->
<!-- trie:section symbol=trie/mcp_server:TrieTools._triefact_view fingerprint=6fe051baa8b00ea0d7a2077e78e06e206fbcc6013df522782bc38b78f2929d26 body_fp=2f21fe1b9f776267eac44cf57305165ef97c36380142752736bbe1cf9250122c source_ref=df7c277d94a9a29198067812a2a9243331b67c81 role=domain -->
...
<!-- trie:end -->
<!-- trie:section symbol=trie/mcp_server:TrieTools._read_symbol fingerprint=b5a34b02e88f650d632f53a7fb838d7418797f7292917fd01e2e21b124a9c241 body_fp=85911eff1374c28fd98dc6b8e19eeb62a1b0cf8f73e82f2ee35eccd65289f1ee source_ref=df7c277d94a9a29198067812a2a9243331b67c81 role=api -->
...
<!-- trie:end -->
<!-- trie:section symbol=trie/mcp_server:TrieTools.explain_symbol fingerprint=df545eeb504005d2c742653bfe7afb1ff4ef9a0238a742a55fe5e401cd457cbd body_fp=41735c806268022fecdbe0f08952edddcf88959b92c06777ca63a4beba675840 source_ref=df7c277d94a9a29198067812a2a9243331b67c81 role=api -->
...
<!-- trie:end -->
<!-- trie:section symbol=trie/mcp_server:build_server fingerprint=5493cf022116b60348bfb7eb49780fa3a1b95da706afc39aee505d178bdb0675 body_fp=713748c5f8d19b55ca39df2ddc2fb109990be31a92d5bde35aebec58a78f6f56 source_ref=c8b279d53ea4a7a3c856c698ff3b034c835ca920 role=orchestration -->
...
<!-- trie:end -->
<!-- trie:section symbol=trie/mcp_server:main fingerprint=67ee5d4f7f32c1a0df4b7add041eecedf6d74e8c4032e8c7bdff5f91552fedd9 body_fp=87be6759d2b659a0120598ba3d2790afe461e3254accc39dd95c1e74c8d2d5d6 source_ref=c8b279d53ea4a7a3c856c698ff3b034c835ca920 role=entrypoint -->
