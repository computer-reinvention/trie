...
- kind: function
  ...
  lines: 34-43
  signature: 'def session_note_ok(note: str) -> bool'
- kind: function
  qualified_name: trie/edits/pipeline:_expand_callers
  lines: 46-77
  signature: 'def _expand_callers( seed_qnames: list[str], store: Store, cascade_depth: int, hub_threshold: int, ) -> set[str]'
- kind: function
  qualified_name: trie/edits/pipeline:preview_patches
  lines: 80-106
  signature: 'def preview_patches(store: Store, config: Config) -> dict[str, Any]'
- kind: function
  qualified_name: trie/edits/pipeline:record_intent
  lines: 109-180
  signature: 'def record_intent( store: Store, config: Config, project_root: Path, *, session_note: str = "", ) -> dict'
- kind: function
  qualified_name: trie/edits/pipeline:_coverage_report
  lines: 183-197
  signature: 'def _coverage_report(store: Store, config: Config, project_root: Path) -> dict'
incoming_refs: 15
outgoing_refs: 1
---
...
<!-- trie:end -->
<!-- trie:section symbol=trie/edits/pipeline:session_note_ok fingerprint=550eef9d58077682531b3b572daa5c4ee8937b76a3429cb0dc3bbf679e779c7e body_fp=5d82c0507dc0a5887069eb416bc04c04c3dd4326b87ab465baccec5267f2b5cc source_ref=93562620aac7b790c8dabcf8f01990451e22c9c3 role=domain -->
...
<!-- trie:end -->
<!-- trie:section symbol=trie/edits/pipeline:_expand_callers fingerprint=217e5c26adaf1a370ac987fe3805925561cf96090adf5cc2321072a7345cf84b body_fp=06cac724121cf3357fa0d6fb3a5fd40b01a4ae63f6f9d9831560f514ab73a748 source_ref=93562620aac7b790c8dabcf8f01990451e22c9c3 role=domain -->
## `def _expand_callers( seed_qnames: list[str], store: Store, cascade_depth: int, hub_threshold: int, ) -> set[str]`
...
<!-- trie:end -->
<!-- trie:section symbol=trie/edits/pipeline:preview_patches fingerprint=1a7d82a23c520c63f7790504ba706aedb20733855251d5e4062f8d352d18ae9c body_fp=57d319ada601827d61f0019da121f2e2c6011f112f32c24e0d28c6fcba741061 source_ref=c360ff8f7df2b3e6b0a8cda993262c2aeead5962 role=domain -->
...
<!-- trie:end -->
<!-- trie:section symbol=trie/edits/pipeline:record_intent fingerprint=9326b2a878fa067c28d451248da289e56c03bfb7b70c35c128aa0c0e92720465 body_fp=f6ad9bfcd27dbc8c94b29850054871d1778cfeb1ba72945393f9586c93b4014d source_ref=a50b31660d0129189f1eeecc691bf1931b0d789b role=domain -->
## `def record_intent( store: Store, config: Config, project_root: Path, *, session_note: str = "", ) -> dict`
...
<!-- trie:end -->
<!-- trie:section symbol=trie/edits/pipeline:_coverage_report fingerprint=e7218a6b13aa3f6dcc8855cee725d9b597f1933c50039dd6de751a3f877b8a22 body_fp=f314a91b13c7ba8f32beca5dbfec1099ca74f5ac8ef037abacd4cf3622882c43 source_ref=a50b31660d0129189f1eeecc691bf1931b0d789b role=domain -->
